...
protected:
	...
	virtual void play(Card, Board&, const Hand&);				// Player plays a card, can override for additional features
	virtual void discard(Card, const Hand&);					// Player discards a card, can override for additional features
