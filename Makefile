...
OBJS = GameWindow.o Subject.o Card.o CardTableController.o CardTableModel.o CardTableView.o CardImageManager.o HandModel.o HandController.o HandView.o main.o
EXEC = main
...
GameWindow.o: GameWindow.h CardTableView.h CardTableModel.h CardTableController.h Card.h HandView.h HandModel.h HandController.h
